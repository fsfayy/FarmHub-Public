...
if gethui():FindFirstChild("FarmHubUI") then
    gethui().FarmHubUI:Destroy()
    gethui().Tooltips:Destroy()
end
...
Info.Text = Info.Text or "FarmHubUI"
...
main.Size = UDim2.new(0, 286, 0, 321)
main.Parent = FarmHubUIScreenGui
...
frame.Size = UDim2.new(0, 100, 0, 11)
frame.Parent = topbar
...
frame1.Size = UDim2.new(0, 286, 0, 1)
frame1.ZIndex = 2
frame1.Parent = frame
...
closeButton.Image = getcustomasset("FarmHubUI/CollapseArrow.png")
closeButton.ImageColor3 = Color3.fromRGB(237, 237, 237)
closeButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
closeButton.BackgroundTransparency = 1
closeButton.Position = UDim2.new(0.912, 0, 0.194, 0)
...
closeButton.MouseButton1Click:Connect(function()
    ...
    for _,v in pairs(main:GetChildren()) do
       if v.Name == "LeftContainer" and v.Visible then
           v.Size = Opened and UDim2.new(0, 168,0, 287) or UDim2.new(0, 168,0, 0)
       end
    end
    end)
    
    TweenService:Create(closeButton, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Rotation = Opened and 0 or 180}):Play()
    TweenService:Create(main, TweenInfo.new(.2, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {Size = Opened and UDim2.new(0, 286,0, 321) or UDim2.new(0, 286,0, 30)}):Play()
end)
...
leftContainer.Position = UDim2.new(0, 115, 0.0935, 0)
...
sectionFrame.ChildAdded:Connect(function(v)
    if v.ClassName == "Frame" then
        ...
        sectionIcon.ImageColor3 = Color3.fromRGB(217, 97, 99)
        sectionIcon.Rotation = 45
    end
end)
...
circleIcon.Image = getcustomasset("FarmHubUI/Circle.png")
...
dropdownIcon.Image = getcustomasset("FarmHubUI/CollapseArrow.png")
...
dropdownContainerTextButton.MouseButton1Click:Connect(function()
    ...
    dropdownText.Text = Info.Text .. ": " ..dropdownbuttonText.Text
...
radioButtonIcon.Image = getcustomasset("FarmHubUI/CollapseArrow.png")
...
radioButtonIcon2.Image = getcustomasset("FarmHubUI/RadioButton.png")
...
radioOuter.Image = getcustomasset("FarmHubUI/RadioOuter.png")
...
radioInner.Image = getcustomasset("FarmHubUI/RadioInner.png")
